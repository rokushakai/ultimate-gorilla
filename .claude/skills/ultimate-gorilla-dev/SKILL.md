...
1. ✅ 最強装備のイベント入手（v0.8）
2. ✅ 図鑑のUMA詳細ステータス表示（v0.8.1）
3. ✅ ストーリーイベント・NPC会話（v0.8.2）
4. ✅ 伝説装備追加・NPCヒント連動イベント（v0.8.3）
5. ✅ BGM/SE・サウンド設定（v0.8.4）
6. ✅ Lv99到達演出・成長達成感アップ（v0.8.5）
7. ✅ BGM重なり修正 + 攻略ペーパービュー屋（v0.8.6）
8. NPC固有イベント深化・仲間システム拡張
9. 横スクロールマップ（v0.9+, 大型改修）
